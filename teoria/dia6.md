...
**1 -**  Diseña un script para identificar a los clientes autorizados a entrar a nuestro sistema.
- Características:
...
**2 -** Diseña un script que imprima los numeros del 1 al 100.
...
**3 -** Diseña un script que imprima los numeros del 100 al 0.
...
**4 -** Diseña un script que imprima los numeros pares entre 0 y 100.
...
**5 -** Diseña un script que imprima los números impares entre un número dado por el usuario y los siguientes 50 números.
